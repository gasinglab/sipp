...
<body>
    ...
    <div class="row">
        ...
        <div class="large-12 columns">
            ...
            <a href="<?php echo base_url(); ?>index.php/c_adm_siswa/tambah" class="button">Tambah Siswa</a>
            </div>
              <table width="100%" border="1">
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?php echo base_url(); ?>index.php/c_adm_siswa/hapus/<?php echo $row->nis; ?>">Hapus</a> | <a href="<?php echo base_url(); ?>index.php/c_adm_siswa/edit_siswa/<?php echo $row->nis; ?>">Edit</a></td>
                </tr>
                <?php } }?>
              </table>
